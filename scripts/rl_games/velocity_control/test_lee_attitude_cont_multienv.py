...
def main():
    ...
    scene_cfg = InteractiveSceneCfg(num_envs=4096, env_spacing=2.5, replicate_physics=True)
    ...
    forces = torch.zeros(4096, 1, 3, device=sim.device)
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            print(f"Applying forces: {forces.shape}, torques: {torques.shape}")
